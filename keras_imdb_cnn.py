...
for idx in range(10):
    ...
    print ("{} : LX {} {} ".format(idx, len(X_train[idx]), y_train[idx]))

print(len(X_train), len(y_train), 'train sequences')
print(len(X_test), len(y_test), 'test sequences')

print('Pad sequences (samples x time) = {}'.format(maxlen))
